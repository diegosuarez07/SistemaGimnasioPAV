...
Public Class InformeProveedorvb
    Private Sub InformeProveedorvb_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        cmdrepo.CommandText = "Select * from ProveedorMaquina"
